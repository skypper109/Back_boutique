            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Limite BTQ</th>
                                ...
                                <td style="text-align: center;">
                                    <form action="{{ route('admin.admins.update-limit', $admin->id) }}" method="POST"
                                        ...
                                        <input type="number" name="boutique_limit" value="{{ $admin->boutique_limit }}"
                                            min="1"
                                            style="width: 50px; padding: 4px; border-radius: 6px; border: 1px solid #ddd; font-weight: 700; text-align: center;">
                                        <button type="submit" class="action-btn-sm" title="Mettre à jour la limite">
