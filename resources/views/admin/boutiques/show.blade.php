...
@section('content')
    ...
    <div class="stats-grid">
        <x-admin-stat type="dark" label="Performance Cumulative" :value="number_format($totalRevenue, 0, ',', ' ')" unit="FCFA" />

        <x-admin-stat type="white" label="Volume de Transactions" :value="number_format($salesCount, 0, ',', ' ')" unit="Ventes" />
            ...
            <div style="margin-top: 15px;">
                <form action="{{ route('admin.boutiques.toggle-status', $boutique->id) }}" method="POST">
                    ...
                    <button type="submit" class="btn"
                        style="background: rgba(255,255,255,0.2); color: white; border: 1px solid rgba(255,255,255,0.3); width: 100%; justify-content: center;">
    ...
    <div class="grid-2-layout" style="margin-top: 40px;">
                        ...
                        @forelse($topProducts as $tp)
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <span
                                        style="font-weight: 800;">{{ number_format($tp->total_amount, 0, ',', ' ') }}</span>
                                    <span class="currency-small">CFA</span>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="3" style="text-align: center; padding: 40px;" class="text-muted italic">
                                    Aucun produit vendu pour le moment.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                            ...
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <div style="font-weight: 800; color: var(--primary);">
                                        {{ number_format($sale->montant_total, 0, ',', ' ') }}</div>
                                    <span class="currency-small">CFA</span>
                                </td>
                            </tr>
                        @empty
